 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.oss.services.countermanagement.test.jee.ejb;

/**
 * Arquillian test - Injecting EJB, Creating Archives and Libraries and test end-to-end functionalities
 */
//@RunWith(Arquillian.class)
public class CounterManagementServiceBeanTest {

//    @EJB
//    private CounterManagementServiceLocal serviceBean;
//
//    @Deployment(name = "ServiceBeanEar")
//    public static Archive<?> createTestArchive() {
//        final MavenDependencyResolver resolver = Artifact.getMavenResolver();
//        final EnterpriseArchive archive = ShrinkWrap.create(EnterpriseArchive.class, CounterManagementServiceBeanTest.class.getSimpleName() + ".ear");
...
//        final JavaArchive archive = ShrinkWrap.create(JavaArchive.class, CounterManagementServiceBeanTest.class.getSimpleName() + "-ejb.jar");
...
//        archive.addClass(CounterManagementServiceLocal.class).addPackage(
//                CounterManagementServiceLocal.class.getPackage().getName());
//        archive.addClass(CounterManagementServiceBean.class).addPackage(CounterManagementServiceBean.class.getPackage().getName());
//        return archive;
//    }
//
//    private static Archive<?> createLibraryArchive() {
//        final JavaArchive archive = ShrinkWrap.create(JavaArchive.class, CounterManagementServiceBeanTest.class.getSimpleName() + "-lib.jar");
//        archive.addAsResource("META-INF/beans.xml", "META-INF/beans.xml");
//        archive.addClass(CounterManagementServiceBeanTest.class).addPackage(CounterManagementService.class.getPackage().getName());
